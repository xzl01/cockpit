window.cockpit_po = {
 ...
 "Cockpit authentication is configured incorrectly.": [
  null,
  "Cockpit overovanie nie je nastavené správne."
 ],
 ...
 "Cockpit might not render correctly in your browser": [
  null,
  "Môže sa stať, že sa Cockpit vo vami používanom webovom prehliadači nebude zobrazovať správne"
 ],
 ...
 "Internal error: Invalid challenge header": [
  null,
  "Interná chyba: neplatná hlavička výzvy"
 ],
 "Invalid date format": [
  null,
 ...
 "Log in with your server user account.": [
  null,
  "Prihláste sa vašim účtom používateľa na serveri."
 ],
 "Log messages": [
  null,
  "Záznamy udalostí"
 ...
 "Please enable JavaScript to use the Web Console.": [
  null,
  "Ak chcete používať webovú konzolu, zapnite podporu pre JavaScript."
 ],
 ...
 "Wrong user name or password": [
  null,
  "Chybné meno používateľa alebo heslo"
 ],
